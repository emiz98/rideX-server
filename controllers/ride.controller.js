...
exports.createRide = (req, res) => {
    ...
    rideService
        ...
        .catch((err) => {
            res.status(400).json({ success: false, error: "Creating a ride failed" });
        });
}
...
exports.getRideDetails = (req, res) => {
    ...
    rideService
        ...
        .catch((err) => {
            res.status(400).json({ success: false, error: "Getting ride details by driver failed" });
        });
}
...
exports.updatePartners = (req, res) => {
    ...
    rideService
        ...
        .catch((err) => {
            res.status(400).json({ success: false, error: "Updating partners to ride failed" });
        });
}
...
exports.deleteRide = (req, res) => {
    ...
    rideService
        ...
        .catch((err) => {
            res.status(400).json({ success: false, error: "Deleting Ride Trip failed" });
        });
}
...
exports.deletePartner = (req, res) => {
    ...
    rideService
        ...
        .catch((err) => {
            res.status(400).json({ success: false, error: "Deleting Ride Partner failed" });
        });
}